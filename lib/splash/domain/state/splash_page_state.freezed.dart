...
mixin _$SplashPageState {
  dynamic get initialCheck => throw _privateConstructorUsedError;
...
class _$SplashPageStateCopyWithImpl<$Res, $Val extends SplashPageState>
  ...
  @override
  $Res call({
    Object? initialCheck = freezed,
  }) {
    return _then(_value.copyWith(
      initialCheck: freezed == initialCheck
          ? _value.initialCheck
          : initialCheck // ignore: cast_nullable_to_non_nullable
              as dynamic,
    ) as $Val);
  }
}
...
class __$$_SplashPageStateCopyWithImpl<$Res>
  ...
  $Res call({
    ...
    return _then(_$_SplashPageState(
      initialCheck:
          freezed == initialCheck ? _value.initialCheck! : initialCheck,
    ));
  }
}
...
class _$_SplashPageState implements _SplashPageState {
  const _$_SplashPageState({this.initialCheck = false});

  @override
  @JsonKey()
  final dynamic initialCheck;

  @override
  String toString() {
    return 'SplashPageState(initialCheck: $initialCheck)';
  }
    ...
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other.initialCheck, initialCheck));
  }

  @override
  int get hashCode => Object.hash(
      runtimeType, const DeepCollectionEquality().hash(initialCheck));
...
abstract class _SplashPageState implements SplashPageState {
  const factory _SplashPageState({final dynamic initialCheck}) =
      _$_SplashPageState;

  @override
  dynamic get initialCheck;
  @override
  @JsonKey(ignore: true)
  _$$_SplashPageStateCopyWith<_$_SplashPageState> get copyWith =>
      throw _privateConstructorUsedError;
