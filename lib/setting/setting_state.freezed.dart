...
mixin _$SettingState {
  AsyncValue<AppVersionItem> get appVersion =>
...
abstract class $SettingStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({AsyncValue<AppVersionItem> appVersion});
}
...
class _$_SettingState implements _SettingState {
  const _$_SettingState({this.appVersion = const AsyncValue.loading()});

  @override
  @JsonKey()
  final AsyncValue<AppVersionItem> appVersion;
...
abstract class _SettingState implements SettingState {
  const factory _SettingState({final AsyncValue<AppVersionItem> appVersion}) =
      _$_SettingState;
